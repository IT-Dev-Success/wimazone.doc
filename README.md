...
Main project repository: [ITDev-Success/billing](https://github.com/ITDev-Success/billing)

## License

Documentation code in this folder follows the local `LICENSE` file. Main application license is proprietary.
