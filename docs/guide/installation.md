...
Cette page récapitule tout ce qu'il faut avoir prêt **avant** de suivre le [Guide d'installation MikroTik](/docs/guide/mikrotik). Wima Zone Billing s'installe exclusivement en **mode container RouterOS v7**, avec une **MariaDB embarquée** persistée sur USB. L'image Docker est multi-arch et couvre ARM 32 (armv7) et ARM 64 bits.
